...
fun ExoDemoScreen(
    ...
    viewModel: ExoDemoViewModel = hiltViewModel<ExoDemoViewModel>(),
    goBack: () -> Unit
) {
    Column(
        modifier = modifier
...
@Composable
fun PlayerUi(modifier: Modifier = Modifier, viewModel: ExoDemoViewModel) {
    AndroidView(
        factory = {
            PlayerView(it).apply {
...
@Composable
fun ActionButton(modifier: Modifier = Modifier, viewModel: ExoDemoViewModel) {
    Row(
